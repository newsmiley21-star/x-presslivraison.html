  ...
  <div id="splash-screen">
    ...
    <div class="flex flex-col items-center z-10 my-auto">
      <div class="ai-glow-container">
        ...
        <img id="splash-logo" src="https://res.cloudinary.com/dyxob1wcj/image/upload/v1781134790/oeqlbzjhuvhbpmrzdpgh.jpg" alt="Logo" class="absolute w-20 h-16 rounded-[1.3rem] object-cover z-10 shadow-xl border-2 border-white">
      </div>
